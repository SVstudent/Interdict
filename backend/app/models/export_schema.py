        ...
        "invariants": [
            {
                ...
                "test": "tests/test_invariants.py::test_committed_verdict_without_evidence_is_rejected",
            ...
            {
                "id": "INV-5",
                "rule": "A side effect is applied at most once per idempotency_key, across crashes.",
                "enforced_by": "store/base.py Repository.record_effect (compare-and-set); "
                               "services/payments.py short-circuits on created=False",
                "test": "tests/test_durability.py::test_exactly_once_block_when_runner_dies_after_the_effect",
            },
            {
                "id": "INV-6",
...
def api_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/api/cases/{case_id}/trace", "returns": "{case_id, spans: Span[]}"},
            ...
            {"method": "GET", "path": "/api/registry", "returns": "{entries: RegistryEntry[], backend}"},
            ...
            {"method": "GET", "path": "/api/audit", "returns": "{records: AuditRecord[], verification}"},
            {"method": "GET", "path": "/api/audit/{case_id}", "returns": "AuditRecord"},
            {"method": "GET", "path": "/api/audit/{case_id}/download", "returns": "AuditRecord (attachment)"},
            ...
            {"method": "POST", "path": "/api/demo/inject_scenario/{id}", "cost": "MODEL CALLS — ~$0.01"},
            ...
            {"method": "GET", "path": "/api/exchange", "returns": "ExchangeFeed + withheld: string[]"},
        ],
        "sse_events": [
